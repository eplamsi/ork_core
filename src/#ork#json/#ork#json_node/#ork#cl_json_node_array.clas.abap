...
CLASS /ork/cl_json_node_array IMPLEMENTATION.
  ...
  METHOD /ork/if_json_node_array~get_array.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
  ...
  METHOD /ork/if_json_node_array~get_bool.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
    RETURN COND #( WHEN candidate IS BOUND
  ...
  METHOD /ork/if_json_node_array~get_bool_value.
    DATA(candidate) = /ork/if_json_node_array~get( index ).
    RETURN COND #( WHEN candidate IS BOUND
                    AND candidate->is_bool( )
  ...
  METHOD /ork/if_json_node_array~get_null.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
    RETURN COND #( WHEN candidate IS BOUND
  ...
  METHOD /ork/if_json_node_array~get_number.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
    RETURN COND #( WHEN candidate IS BOUND
  ...
  METHOD /ork/if_json_node_array~get_number_value.
    DATA(candidate) = /ork/if_json_node_array~get( index ).
    RETURN COND #( WHEN candidate IS BOUND
                    AND candidate->is_number( )
  ...
  METHOD /ork/if_json_node_array~get_object.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
    RETURN COND #( WHEN candidate IS BOUND
  ...
  METHOD /ork/if_json_node_array~get_string.
    DATA(candidate) = /ork/if_json_node_array~get( index    = index
                                                   fallback = fallback ).
    RETURN COND #( WHEN candidate IS BOUND
  ...
  METHOD /ork/if_json_node_array~get_string_value.
    DATA(candidate) = /ork/if_json_node_array~get( index ).
    RETURN COND #( WHEN candidate IS BOUND
                    AND candidate->is_string( )
